...
// Exercise 1: validate an invalid resource
// (hint: https://www.hl7.org/fhir/resource-operation-validate.html)
const invalidGoal = {
  resourceType: "Goal",
  description: {
...
// Exercise 2: Now a vaild one to create
// (hint: https://www.hl7.org/fhir/http.html#create)
const validGoal = {
  resourceType: "Goal",
...
// Exercise: Make an observation, the number of we steps today
